...
$.extend($.fn.dialog.defaults, fq.onMove);
$.extend($.fn.window.defaults, fq.onMove);
$.extend($.fn.panel.defaults, fq.onMove);
...
$.extend($.fn.datagrid.defaults, fq.onLoadError);
$.extend($.fn.treegrid.defaults, fq.onLoadError);
$.extend($.fn.tree.defaults, fq.onLoadError);
$.extend($.fn.combogrid.defaults, fq.onLoadError);
$.extend($.fn.combobox.defaults, fq.onLoadError);
$.extend($.fn.form.defaults, fq.onLoadError);
...
$.extend($.fn.combotree.defaults, fq.loadFilter);
$.extend($.fn.tree.defaults, fq.loadFilter);
 ...
 * 
 */
fq.modalDialog = function(options) {
 ...
 * @param themeName
 */
fq.changeTheme = function(themeName) {
	...
	fq.cookie('easyuiTheme', themeName, {
		expires : 7
	});
};
 ...
 * @requires jQuery,EasyUI
 */
fq.progressBar = function(options) {
