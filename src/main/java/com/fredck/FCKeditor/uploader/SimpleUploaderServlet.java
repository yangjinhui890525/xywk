/*秦刚
 * ksdjfksdjffsdfsdfjsdklfjksdlfjksdf
 * ksdjfksdjfksldjfklsdjfksdjfklsdf
...
public class SimpleUploaderServlet extends HttpServlet {
	...
	public Hashtable getAllowedExtensions() {
		return allowedExtensions;
	}


	public void setAllowedExtensions(Hashtable allowedExtensions) {
		this.allowedExtensions = allowedExtensions;
	}


	public Hashtable getDeniedExtensions() {
		return deniedExtensions;
	}


	public void setDeniedExtensions(Hashtable deniedExtensions) {
	 ...
	 */
	 public void init() throws ServletException {
		...
		this.enabled=(new Boolean(getInitParameter("enabled"))).booleanValue();
		if(this.encoding==null)
		{
			this. encoding="UTF-8";
		}
		if(this.baseDir==null)
			this.baseDir="/UserFiles/";
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(enabled) {		
			...
			try {
				...
				uplFile.getString(encoding);//自己添加
